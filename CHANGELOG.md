...
- Fixed decryption error handling to allow workflows to be listed even when token decryption fails - errors now surface only when attempting to use the token (e.g., triggering workflows or viewing history)
